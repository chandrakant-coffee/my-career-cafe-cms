<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            data-kt-scroll-dependencies="#kt_aside_logo", data-kt-scroll-offset="0">
            <!--begin::Menu-->
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div class="menu-item ">
                    <a class="menu-link @if ($route[0] == 'users') active @endif"
                ...
                <div class="menu-item ">
                    <a class="menu-link @if ($route[0] == 'role-permission') active @endif"
                ...
                <div class="menu-item ">
                    <a class="menu-link @if ($route[0] == 'permission-listing') active @endif"
                ...
                <div data-kt-menu-trigger="click"
                    class="menu-item menu-accordion mt-3 @if ( $route[0] == 'footer' || $route[0] == 'header') hover show @endif">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg    @if ( $route[0] == 'header' || $route[0] == 'header') show @endif">
                        <div class="menu-item">
                            <a class="menu-link @if ($route[0] == 'header') active @endif"
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg    @if ( $route[0] == 'footer' || $route[0] == 'header') show @endif">
                        <div class="menu-item">
                            <a class="menu-link @if ($route[0] == 'footer') active @endif"
