                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header flex-wrap py-3">
                            ...
                            <div class="card-toolbar">
                                <a href="{{ route('tips.create') }}" class="btn btn-sm btn-light-primary"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @php
                                                    ...
                                                    //dd( $image_data );
                                                @endphp
                                                <img class="IndexImg" src="{{url('/')}}/{{ $image_data->path }}" alt="{{ $image_data->alt }}" srcset="" />
                                            </td>
                                            <td>
                                                {{  $value->category }}
                                            </td>
                                            <td style="display:flex;">
                                                ...
                                                <a href="{{ route('tips.edit', $value->id) }}"
                                                    class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1"
                                                    data-bs-trigger="hover" data-bs-toggle="tooltip" data-bs-placement="top"
                                                    title="Click To Edit">
                                                    <i class="bi bi-vector-pen fs-3"></i>
                                                </a>
                                                <form action="{{ route('tips.destroy', $value->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="button"
