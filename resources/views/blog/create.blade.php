                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card card-custom example example-compact">
                            <form action="{{ route('blog.store') }}" autocomplete="off" method="POST" class="form" id="FormId" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="mb-5">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-10">
                                                <input type="file" name="featureImg" data-bvalidator="required, extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg" class="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-5">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-10">
                                                <select class="form-control" required name="categoryID">
                                                    ...
                                                    <option value="{{$value->id}}">{{$value->catTitle}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
