                                    ...
                                    <div class="mb-5">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-10">
                                                ...
                                                @endphp
                                                <select class="form-control js-example-placeholder-single" multiple="multiple" name="insights_and_tips_section_tips_id[]" id="product_id" data-bvalidator="required">
